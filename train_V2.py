...
# ✅ 데이터 로드 및 전처리
df1 = pd.read_csv("data/sample_data_full.csv")
...
print("🎉 전체 학습 완료! 이제 kobert_cuss_epoch(25)_batch_size=32_누적 2만4천개+비욕설 3천개(15에폭)+욕설 7천개(3에폭)+비욕설 3천개(3에폭)+욕설천개(에폭3)+비욕설500개(에폭3)+욕설100개(에폭3).pth 모델을 사용할 수 있어요.")
